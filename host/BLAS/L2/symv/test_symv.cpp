...
void OOPS_symv(const char Uplo, const int N, const float alpha, const float  *A, const int lda,
                ...
                cl::Kernel krnl;
                OCL_CHECK(err, krnl= cl::Kernel (program,"krnl_symv", &err));
                
		// Allocate Buffer in Global Memory
                OCL_CHECK(err, cl::Buffer Sx1(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, sizeof(float)*N*incX, (void *) X, &err));
                OCL_CHECK(err, cl::Buffer Sx2(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, sizeof(float)*N*incX, (void *) X, &err));
                OCL_CHECK(err, cl::Buffer Sx3(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, sizeof(float)*N*incX, (void *) X, &err));
                OCL_CHECK(err, cl::Buffer Sx4(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, sizeof(float)*N*incX, (void *) X, &err));
                OCL_CHECK(err, cl::Buffer Sx5(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, sizeof(float)*N*incX, (void *) X, &err));
                OCL_CHECK(err, cl::Buffer Sx6(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, sizeof(float)*N*incX, (void *) X, &err));
                OCL_CHECK(err, cl::Buffer Sx7(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, sizeof(float)*N*incX, (void *) X, &err));
                OCL_CHECK(err, cl::Buffer Sx8(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, sizeof(float)*N*incX, (void *) X, &err));
                OCL_CHECK(err, cl::Buffer Sx9(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, sizeof(float)*N*incX, (void *) X, &err));
                OCL_CHECK(err, cl::Buffer Sx10(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, sizeof(float)*N*incX, (void *) X, &err));

                OCL_CHECK(err, cl::Buffer Sy1(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*rows_counter[0]*incY, (void *) Y, &err));
                OCL_CHECK(err, cl::Buffer Sy2(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*(rows_counter[1]-rows_counter[0])*incY, (void *) &Y[rows_counter[0]], &err));
                OCL_CHECK(err, cl::Buffer Sy3(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*(rows_counter[2]-rows_counter[1])*incY, (void *) &Y[rows_counter[1]], &err));
                OCL_CHECK(err, cl::Buffer Sy4(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*(rows_counter[3]-rows_counter[2])*incY, (void *) &Y[rows_counter[2]], &err));
                OCL_CHECK(err, cl::Buffer Sy5(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*(rows_counter[4]-rows_counter[3])*incY, (void *) &Y[rows_counter[3]], &err));
                OCL_CHECK(err, cl::Buffer Sy6(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*(rows_counter[5]-rows_counter[4])*incY, (void *) &Y[rows_counter[4]], &err));
                OCL_CHECK(err, cl::Buffer Sy7(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*(rows_counter[6]-rows_counter[5])*incY, (void *) &Y[rows_counter[5]], &err));
                OCL_CHECK(err, cl::Buffer Sy8(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*(rows_counter[7]-rows_counter[6])*incY, (void *) &Y[rows_counter[6]], &err));
                OCL_CHECK(err, cl::Buffer Sy9(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*(rows_counter[8]-rows_counter[7])*incY, (void *) &Y[rows_counter[7]], &err));
                OCL_CHECK(err, cl::Buffer Sy10(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*(N-rows_counter[8])*incY, (void *) &Y[rows_counter[8]], &err));
		
		OCL_CHECK(err, cl::Buffer Sy1_sym(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*N*incY, (void *) Y1_sym, &err));
                OCL_CHECK(err, cl::Buffer Sy2_sym(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*N*incY, (void *) Y2_sym, &err));
                OCL_CHECK(err, cl::Buffer Sy3_sym(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*N*incY, (void *) Y3_sym, &err));
                OCL_CHECK(err, cl::Buffer Sy4_sym(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*N*incY, (void *) Y4_sym, &err));
                OCL_CHECK(err, cl::Buffer Sy5_sym(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*N*incY, (void *) Y5_sym, &err));
                OCL_CHECK(err, cl::Buffer Sy6_sym(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*N*incY, (void *) Y6_sym, &err));
                OCL_CHECK(err, cl::Buffer Sy7_sym(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*N*incY, (void *) Y7_sym, &err));
                OCL_CHECK(err, cl::Buffer Sy8_sym(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*N*incY, (void *) Y8_sym, &err));
                OCL_CHECK(err, cl::Buffer Sy9_sym(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*N*incY, (void *) Y9_sym, &err));
                OCL_CHECK(err, cl::Buffer Sy10_sym(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, sizeof(float)*N*incY, (void *) Y10_sym, &err));
                ...
                OCL_CHECK(err, cl::Buffer Sa10(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, sizeof(float)*(N-rows_counter[8])*N, (void *) &A[rows_counter[8]*N], &err));
